...
export const BackgroundBeamsWithCollision = ({ children, className }) => {
  ...
  return (
    <div
      ref={parentRef}
      className={cn(
        "fixed top-0 left-0 w-full min-h-screen bg-gray-900 overflow-hidden pointer-events-none -z-10", // Dark background for visibility
        className
      )}
    >
      ...
      <div
        ref={containerRef}
        className="absolute bottom-0 bg-gray-700 w-full inset-x-0 pointer-events-none"
        style={{
          boxShadow:
  ...
  return (
    <>
      <motion.div
        ...
        className={cn(
          "absolute left-0 top-20 m-auto h-14 w-1 rounded-full bg-gradient-to-t from-indigo-500 via-purple-500 to-transparent",
